    ...
    <footer className="footer">
      ...
      <div className="container footer__inner">
        ...
        <div className="footer__brand">
          <div className="footer__logo">
            ...
            <span className="footer__logo-name">SHUBHAM<span className="footer__logo-ai">.DEV</span></span>
          </div>
          <p className="footer__tagline">
            Building scalable backend services, secure APIs &<br />
            production-ready Java systems.
          </p>
          <div className="footer__socials">
            <a href={personalInfo.github} target="_blank" rel="noreferrer" className="footer__social" aria-label="GitHub">
            ...
            <a href={personalInfo.linkedin} target="_blank" rel="noreferrer" className="footer__social" aria-label="LinkedIn">
        ...
        <div className="footer__nav-group">
          ...
          <nav className="footer__nav">
            {['Java Backend Systems', 'Spring Boot APIs', 'Microservices', 'JWT Authentication', 'Hibernate & JPA', 'Database Optimization'].map(s => (
        ...
        <div className="footer__nav-group">
          <span className="footer__nav-title">Domains</span>
          <nav className="footer__nav">
            {['AI Hiring Platforms', 'Banking Systems', 'Parking Operations', 'Backend Platforms', 'Cloud Deployment', 'Web Integration'].map(s => (
              <span key={s} className="footer__nav-link footer__nav-link--plain">{s}</span>
            ))}
          </nav>
        </div>
      ...
      <div className="footer__bottom">
        <div className="container footer__bottom-inner">
          <span className="footer__copy">© {year} {personalInfo.name}. All rights reserved.</span>
          <span className="footer__built">Built with Java backend focus. Designed for production systems.</span>
        </div>
      </div>
    </footer>
  );
